...
async def save_application(
    ...
    exp_position: str | None = None,
    exp_duration: str | None = None,
    exp_duties: str | None = None,
    salary: str | None = None,
    schedule: str | None = None,
    evening_shifts: str | None = None,
    ...
    # Языки сериализуем в JSON-строку для хранения в Text-колонке
    ...
    app = Application(
        ...
        is_video_note=1 if is_video_note else 0,
