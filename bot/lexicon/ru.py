...
TEXTS_RU = {
    ...
    "ask_citizenship": "🔹 Укажите <b>гражданство</b> или нажмите «⏭ Пропустить»:",
    "ask_address":     "🏡 Введите <b>адрес проживания</b>\n(город, район, улица / квартал):",
    "ask_metro":       "🚇 Выберите <b>ближайшее метро</b> или нажмите «⏭ Пропустить»:",
    ...
    # ── Защита от дублей ─────────────────────────────────────
    "anketa_block_pending":  "⏳ <b>Ваша анкета уже на рассмотрении.</b>\n\nДождитесь ответа HR-менеджера — повторная подача пока недоступна.",
    "anketa_block_accepted": "✅ <b>Вы уже приглашены на собеседование!</b>\n\nЖдём вас в назначенное время.",
    "anketa_block_hired":    "🏆 <b>Вы уже являетесь сотрудником MADO!</b>",
    "anketa_block_hold":     "⏸ <b>Ваша анкета отложена в резерв.</b>\n\nHR-менеджер вернётся к ней позже. Повторная подача пока недоступна.",
    "anketa_already_exists": "⏳ <b>У вас уже есть активная заявка.</b>\n\nПовторная отправка невозможна.",
    ...
    "candidate_hold_notice": (
        "⏸ <b>Ваша анкета отложена в резерв.</b>\n\n"
