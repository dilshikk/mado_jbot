...
"""Раздел «Метро» в административной панели. Полностью Inline Keyboard."""
...
# ── metro:confirm_delete:{id}:{line_id} ──────────────────────────────────────
...
# ── metro:add:{line_id} → FSM (линия уже известна) ───────────────────────────
...
# ── metro:add_line:{line_id} (из выбора линии) ────────────────────────────────
